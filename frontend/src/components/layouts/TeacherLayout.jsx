...
const TeacherLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Diary', path: '/teacher/diary', icon: '📝' },
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-gray-500 font-medium">
                  {user?.assignedClass ? `Class: ${user.assignedClass}` : 'Class Management'}
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
          ...
          <div className="lg:hidden p-4 border-b border-gray-200 bg-gradient-to-br from-primary-50 via-yellow-50 to-primary-50">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                {user?.assignedClass && (
                  <p className="text-xs text-primary-600 font-medium mt-1">Class: {user.assignedClass}</p>
                )}
              </div>
            </div>
            <button
