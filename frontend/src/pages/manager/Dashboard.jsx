...
const Dashboard = () => {
  ...
  const stats = [
    { title: 'Parents', value: dashboardStats?.parents || 0, icon: '👨‍👩‍👧', color: 'bg-blue-500' },
    { title: 'Students', value: dashboardStats?.students || 0, icon: '👨‍🎓', color: 'bg-green-500' },
    { title: 'Routes', value: dashboardStats?.routes || 0, icon: '🗺️', color: 'bg-yellow-500' },
    { title: 'Drivers', value: dashboardStats?.drivers || 0, icon: '🚗', color: 'bg-purple-500' },
  ]
